...
public class SecondScreen extends AppCompatActivity {
    ...
    //    weather api
    final String APP_ID = "373bdd109498c5ffc6a86956ccc3b790";
    //    weather api
    ...
    private void letsdoSomeNetworking(RequestParams params)
    {
        ...
        client.get(WEATHER_URL,params,new JsonHttpResponseHandler()
        {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response)
            {
                ...
                com.example.weatherap.WeatherData weatherD= null;
                try {
                    weatherD = com.example.weatherap.WeatherData.fromJson(response);
    ...
    private void updateUI(com.example.weatherap.WeatherData weather)
    {
